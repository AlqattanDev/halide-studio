  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Live prompt–image studio. Change the text and the plate follows. Request a change and the prompt rewrites itself.",
      },
    ...
    <html lang="en" className="dark antialiased" suppressHydrationWarning>
      ...
      <body className="bg-bg text-fg">
        ...
        <Toaster
          ...
          toastOptions={{
            className:
              "!bg-raised !text-fg !border-0 !shadow-[var(--shadow-border)] !font-sans",
          }}
        />
        <Scripts />
      </body>
